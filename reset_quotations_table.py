...
def reset_quotations_table():
    """
    Drops and recreates the quotations table with the latest schema (including artwork_image).
    ...
    print("Quotations table has been reset with the latest schema (including artwork_image).")
